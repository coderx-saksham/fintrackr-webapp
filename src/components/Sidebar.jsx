...
const Sidebar = ({activeMenu}) => {
    ...
    return (
        <div className="w-64 h-[calc(100vh-61px)] bg-white border-gray-200/50 p-5 sticky top-[61px] z-20 overflow-y-auto">
            <div className="flex flex-col items-center justify-center gap-3 mt-3 mb-7">
                <Avatar src={user?.profileImageUrl} className="w-20 h-20" iconClassName="w-10 h-10" />
